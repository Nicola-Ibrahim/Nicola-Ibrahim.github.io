...
export default function ThreadsVsCoroutines() {
  ...
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8 font-sans transition-colors duration-500">
    ...
    <div className="bg-white dark:bg-[#1e1e1e] p-6 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-lg text-slate-800 dark:text-slate-200 transition-colors">
      ...
      <div className="bg-teal-50 dark:bg-teal-900/40 text-teal-900 dark:text-teal-200 py-2 px-4 rounded-lg text-center text-[10px] font-black mb-4 border border-teal-100 dark:border-transparent uppercase tracking-wider">Event loop — single thread, picks next ready coroutine</div>
      <div className="flex justify-between gap-4 mb-6">
         <div className="flex-1 flex flex-col gap-3">
            ...
            <div className="bg-teal-50 dark:bg-teal-900/40 text-teal-900 dark:text-teal-200 py-2.5 px-2 text-center rounded-lg font-bold text-[10px] border border-teal-100 dark:border-transparent uppercase">await DB → PAUSE</div>
            ...
            <div className="text-center text-[10px] font-black text-teal-600 dark:text-teal-400 py-1 uppercase tracking-tighter">DB returns → RESUME</div>
         ...
         <div className="flex-1 flex flex-col gap-3">
            ...
            <div className="bg-teal-50 dark:bg-teal-900/40 text-teal-900 dark:text-teal-200 py-2.5 px-2 text-center rounded-lg font-bold text-[10px] border border-teal-100 dark:border-transparent uppercase">await HTTP → PAUSE</div>
            <div className="bg-slate-100 dark:bg-[#d3d1c7] text-slate-500 dark:text-[#444441] py-2.5 px-2 text-center rounded-lg font-medium text-[10px]">suspended cheaply</div>
